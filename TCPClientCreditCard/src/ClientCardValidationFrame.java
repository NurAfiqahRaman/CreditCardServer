...
public class ClientCardValidationFrame extends JFrame {
	...
	private JLabel lblServerMessage;
	 ...
	 * the frame.
	 */
	public ClientCardValidationFrame () {
	...
	public void updateServerMessage (String message) {
		...
		this.lblServerMessage.setText(message);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		lblServerMessage.setFont(font);
		lblDate.setBackground(Color.WHITE);
		lblDate.setOpaque(true);
		lblServerMessage.setBackground(Color.WHITE);
		lblServerMessage.setOpaque(true);

		// Organize components into panel
		panel.add(lblDate);
		panel.add(lblServerMessage);
